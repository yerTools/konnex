...
func init() {
	m.Register(func(app core.App) error {
		...
		settings.Meta.AppName = "Konnex"
		settings.Meta.AppURL = "https://github.com/yerTools/konnex"
		settings.Meta.HideControls = true
		settings.Meta.SenderName = "Konnex"
		settings.Meta.SenderAddress = "konnex@ltl.re"
